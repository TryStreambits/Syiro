...
(c=c.querySelector('div[data-syiro-minor-component="list-content"]')):h=!0;h&&null!==c&&null!==d&&("prepend"==b?c.insertBefore(d,c.firstChild):c.appendChild(d),"list"==e.type&&(c=c.parentElement),a.component.Update(e.id,c));return h};f.Remove=function(b){var c=b;a.utilities.TypeOfThing(b,"array")||(c=[b]);for(b=0;b<c.length;b++){var d=c[b],e=a.utilities.TypeOfThing(d),g,h;"ComponentObject"==e?(g=d,h=a.component.Fetch(d)):"Element"==e&&(g=a.component.FetchComponentObject(d),h=d);a.utilities.TypeOfThing(h,
"Element")&&(d=h.parentElement,!1!==a.data.Read(g.id)&&a.data.Delete(g.id),null!==d&&d.hasAttribute("data-syiro-component-id")&&(d.removeChild(h),a.component.Update(d.getAttribute("data-syiro-component-id")+"->HTMLElement",d)))}}})(a.component||(a.component={}))})(syiro||(syiro={}));
