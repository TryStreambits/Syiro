...
f.length;h++){var k=f[h];if(""!==d.canPlayType(k.type)){e=!0;break}if(!g&&a.utilities.TypeOfThing(k.streamable,"string")&&"true"==k.streamable){g=!0;break}}return c&&g?"streamable":e?!0:!1};f.IsPlaying=function(b){a.component.Fetch(b);return!a.mediaplayer.FetchInnerContentElement(b).paused};f.IsStreamable=function(b){return"streamable"==a.mediaplayer.IsPlayable(b,!0)};f.PlayOrPause=function(b,c){var d=a.component.Fetch(b),e=a.mediaplayer.FetchInnerContentElement(b),g=a.utilities.TypeOfThing(c);"video"==
d.getAttribute("data-syiro-component-type")&&d.setAttribute("data-syiro-show-video","true");d="ComponentObject"==g?a.component.Fetch(c):"Element"!==g||"play"!==c.getAttribute("data-syiro-render-icon")?d.querySelector('div[data-syiro-render-icon="play"]'):c;a.mediaplayer.IsPlaying(b)?(e.pause(),d.removeAttribute("active")):(e.play(),d.setAttribute("active","pause"))};f.Reset=function(b){a.component.Fetch(b);var c=a.mediaplayer.FetchInnerContentElement(b);a.mediaplayer.IsPlaying(b)&&c.pause();a.mediaplayer.SetTime(b,
0);a.mediaplayer.Configure(b)};f.SetSources=function(b,c){a.component.Fetch(b);var d=a.mediaplayer.FetchInnerContentElement(b),e=d.nodeName.toLowerCase();"string"==typeof c&&(c=[c]);e=a.mediaplayer.GenerateSources(e,c);d.innerHTML="";for(var g=0;g<e.length;g++)d.appendChild(e[g]);d.setAttribute("src",c[0]);d.src=c[0];a.mediaplayer.Reset(b)};f.SetTime=function(b,c){if(0==a.data.Read(b.id+"->IsStreaming")){var d=a.component.Fetch(b),e=a.mediaplayer.FetchInnerContentElement(b),g=e.currentTime,h=g,f=
"string"==typeof c;!f&&g!==c&&c<=e.duration&&(h=e.currentTime=c);d=d.querySelector('div[data-syiro-component="media-control"]');e=a.component.FetchComponentObject(d);d=d.querySelector('div[data-syiro-minor-component="progressbar"] > input');a.mediacontrol.TimeLabelUpdater(e,0,h);e=a.data.Read(b.id+"->IsChangingInputValue");g=!1;e&&!f?g=!0:!e&&f&&(g=!0);g&&(f=Math.floor(h),d.value=f,f=f/Number(d.max)*d.clientWidth,e="",0!==h&&(e="linear-gradient(to right, "+a.primaryColor+" "+f+"px, transparent 0px)"),
a.style.Set(d,"background",e))}};f.SetVolume=function(b,c,d){var e=a.component.Fetch(b);b=a.mediaplayer.FetchInnerContentElement(b);var e=e.querySelector('div[data-syiro-minor-component="progressbar"] > input'),g=c;"string"==typeof d&&"input"==d?(g*=10,c/=10):10<g&&100>=g?(g=10*Math.round(c/10),c/=100):1<g&&10>=g?(g*=10,c/=10):1>=g&&(g*=100);a.style.Set(e,"background","linear-gradient(to right, "+a.primaryColor+" "+g+"%, transparent 0px)");b.volume=c};f.ToggleFullscreen=function(b){b=a.component.Fetch(b);
