...
d.appendChild(a.component.Fetch(b)));"iOS"!==a.device.OperatingSystem&&(b=a.button.New({icon:"volume"}),d.appendChild(a.component.Fetch(b)));a.data.Write(c.id+"->HTMLElement",d);return c};f.ShowVolumeSlider=function(b,c){var d=a.component.Fetch(b),e=a.component.Fetch(c),g=a.component.FetchComponentObject(d.parentElement),h=a.mediaplayer.FetchInnerContentElement(g),f=d.querySelector('div[data-syiro-minor-component="progressbar"] > input');0==a.data.Read(g.id+"->IsChangingVolume")?(a.data.Write(g.id+
"->IsChangingInputValue",!0),a.data.Write(g.id+"->IsChangingVolume",!0),e.setAttribute("active","true"),a.data.Read(g.id+"->IsStreaming")&&d.removeAttribute("data-syiro-component-streamstyling"),f.setAttribute("max","10"),f.setAttribute("step","1"),a.mediaplayer.SetVolume(g,h.volume)):(e.removeAttribute("active"),a.data.Read(g.id+"->IsStreaming")&&d.setAttribute("data-syiro-component-streamstyling",""),d=a.mediaplayer.GetPlayerLengthInfo(g),f.setAttribute("max",d.max),f.setAttribute("step",d.step),
