...
a.mediaplayer.Reset(b)};f.SetTime=function(b,c){if(0==a.data.Read(b.id+"->IsStreaming")){var d=a.component.Fetch(b),e=a.mediaplayer.FetchInnerContentElement(b),g=e.currentTime,h=g,f="string"==typeof c;!f&&g!==c&&c<=e.duration&&(h=e.currentTime=c);d=d.querySelector('div[data-syiro-component="media-control"]');e=a.component.FetchComponentObject(d);d=d.querySelector("input");a.mediacontrol.TimeLabelUpdater(e,0,h);e=a.data.Read(b.id+"->IsChangingInputValue");g=!1;e&&!f?g=!0:!e&&f&&(g=!0);g&&(f=Math.floor(h),
d.value=f,f=f/Number(d.max)*d.clientWidth,e="",0!==h&&(e="linear-gradient(to right, "+a.primaryColor+" "+f+"px, transparent 0px)"),a.style.Set(d,"background",e))}};f.SetVolume=function(b,c,d){var e=a.component.Fetch(b);b=a.mediaplayer.FetchInnerContentElement(b);var e=e.querySelector('input[type="range"]'),g=c;"string"==typeof d&&"input"==d?(g*=10,c/=10):10<g&&100>=g?(g=10*Math.round(c/10),c/=100):1<g&&10>=g?(g*=10,c/=10):1>=g&&(g*=100);a.style.Set(e,"background","linear-gradient(to right, "+a.primaryColor+
...
"update-input"))};f.TimeLabelUpdater=function(b,c,d){b=a.component.Fetch(b).querySelector("time");if(null!==b){var e="";if("number"==typeof d){d=a.utilities.SecondsToTimeFormat(d);for(var g in d)var f=d[g],e=0!==e.length?e+":"+f:f}else e=d;g=b.textContent.split(" / ");g[c]=e;b.textContent=g[0]+" / "+g[1]}};f.Toggle=function(b,c){var d=a.component.Fetch(b),e;d.hasAttribute("data-syiro-animation")&&(e=d.getAttribute("data-syiro-animation"));"boolean"!==typeof c&&(c=null);if(c)a.animation.FadeIn(b);
else if(0==c)a.animation.FadeOut(b);else if("undefined"==typeof c||null==c)"fade-out"==e||0==d.hasAttribute("data-syiro-animation")?a.animation.FadeIn(b):a.animation.FadeOut(b)}})(a.mediacontrol||(a.mediacontrol={}))})(syiro||(syiro={}));
...
f.Toggle=function(b,c){var d=a.component.Fetch(b);if("dropdown"==d.getAttribute("data-syiro-component-type")){var e=a.component.FetchLinkedListComponentObject(b),f=a.component.Fetch(e);if(""!==a.style.Get(f,"visibility"))d.removeAttribute("active"),a.style.Set(f,"visibility","");else{var h=d.clientWidth;200>h&&(h=200);a.style.Set(f,"width",h+"px");h=a.data.Read(e.id+"->render");a.render.Position(h,e,b);d.setAttribute("active","");a.style.Set(f,"visibility","visible")}}else"toggle"==d.getAttribute("data-syiro-component-type")&&
((c="undefined"==typeof c?d.hasAttribute("active"):!c)?(a.animation.Reset(b),d.removeAttribute("active")):(a.animation.Slide(b),d.setAttribute("active","true")))}})(a.button||(a.button={}))})(syiro||(syiro={}));
