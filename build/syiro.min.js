...
-1!==b.icon.indexOf(".")&&(d["data-syiro-render-icon"]="custom",d.style='background-image: url("'+b.icon+'")'));delete b.icon;if("string"==typeof b.image){var e=a.utilities.ElementCreator("img",{src:b.image});b.content=e.outerHTML+b.content;delete b.image}"string"==typeof b.content&&(d.content=b.content,delete b.content)}if("dropdown"==b.type){e=b.list;delete b.list;a.utilities.TypeOfThing(b.items,"Array")&&(e=a.list.New({items:b.items}),delete b.items);var f=a.component.Fetch(e);document.body.appendChild(f);
f.setAttribute("data-syiro-component-owner",c);d["aria-owns"]=e.id;a.utilities.TypeOfThing(b.position,"Array")||(b.position=["below","center"]);a.data.Write(e.id+"->render",b.position);delete b.position}else"toggle"==b.type&&(e={"data-syiro-minor-component":"buttonToggle"},b["default"]&&(e["data-syiro-component-status"]="true",delete b["default"]),d.content=a.utilities.ElementCreator("div",e));delete b.type;d=a.utilities.ElementCreator("div",d);if(0!==Object.keys(b).length)for(var h in b)d.setAttribute(h,
b[h]);a.data.Write(c+"->HTMLElement",d);return{id:c,type:"button"}};f.SetIcon=function(b,c){var d=!1,e=a.component.Fetch(b);null!==e&&"toggle"!==e.getAttribute("data-syiro-component-type")&&(""!==c?(a.style.Set(e,"background-image",'url("'+c+'")'),e.setAttribute("data-syiro-render-icon","custom")):(a.style.Set(e,"background-image",""),e.removeAttribute("data-syiro-render-icon")),a.component.Update(b.id+"->HTMLElement",e),d=!0);return d};f.SetImage=function(b,c){var d=!1,e=a.component.Fetch(b);null!==
e&&"toggle"!==e.getAttribute("data-syiro-component-type")&&(d=e.querySelector("img"),""!==c?(null==d&&(d=document.createElement("img"),e.insertBefore(d,e.firstChild)),d.setAttribute("src",c),a.component.Update(b.id,e)):""==c&&null!==d&&a.component.Remove(d),d=!0);return d};f.SetText=function(b,c){var d=!1,e=a.component.Fetch(b);null!==e&&"toggle"!==e.getAttribute("data-syiro-component-type")&&(e.textContent=c,a.component.Update(b.id,e),d=!0);return d};f.Toggle=function(b,c){var d=a.component.Fetch(b);
if("dropdown"==d.getAttribute("data-syiro-component-type")){var e=a.component.FetchLinkedListComponentObject(b),f=a.component.Fetch(e);if(""!==a.style.Get(f,"visibility"))d.removeAttribute("active"),a.style.Set(f,"visibility","");else{var h=a.data.Read(e.id+"->render");a.render.Position(h,e,b);d.setAttribute("active","");a.style.Set(f,"visibility","visible")}}else"toggle"==d.getAttribute("data-syiro-component-type")&&(a.utilities.TypeOfThing(c,"MouseEvent")&&(c=d.hasAttribute("active")),c?(a.animation.Reset(b),
d.removeAttribute("active")):(a.animation.Slide(b),d.setAttribute("active","true")))}})(a.button||(a.button={}))})(syiro||(syiro={}));
