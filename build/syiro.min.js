...
f.SetLabel=a.button.SetText;f.Toggle=function(b,c){var d=a.component.Fetch(b);if("dropdown"==d.getAttribute("data-syiro-component-type")){var e=a.component.FetchLinkedListComponentObject(b),f=a.component.Fetch(e);if(""!==a.style.Get(f,"visibility"))d.removeAttribute("active"),a.style.Set(f,"visibility","");else{var h=d.clientWidth;200>h&&(h=200);a.style.Set(f,"width",h+"px");h=a.data.Read(e.id+"->render");a.render.Position(h,e,b);d.setAttribute("active","");a.style.Set(f,"visibility","visible")}}else"toggle"==
