...
"input"==c.localName&&(d=c.value);c=0;for(b=a.data.Read(e.id+"->handlers->"+b);c<b.length;c++)b[c].call(this,e,d)};f.Add=function(b,c,d){var e=!0;if(3==arguments.length){"string"==typeof b&&(b=b.replace(" ","").split(","));var g=a.component.FetchComponentObject(c),h=a.component.Fetch(c);"list-item"==g.type?e=null==h.querySelector("div"):"searchbox"==g.type&&(h=h.querySelector("input"));if(e)for(var f=0,k=b;f<k.length;f++){var m=k[f],n=a.data.Read(g.id+"->handlers->"+m);"boolean"==typeof n?(n=[d],
...
typeof b[2]&&(h=b[2]);if(d&&a.utilities.TypeOfThing(f,"Element")){for(b=0;b<g.length;b++){d=g[b];e=null;if("function"==typeof h){var e=a.data.Read(c.id+"->handlers->"+d),k=e.indexOf(h);-1!==k&&e.splice(k,1)}null==e||0==e.length?(a.data.Delete(c.id+"->handlers->"+d),f.removeEventListener(d,a.events.Handler.bind(this,c))):a.data.Write(c.id+"->handlers->"+d,e)}e=!0}}return e}})(a.events||(a.events={}))})(syiro||(syiro={}));
...
(function(a){(function(f){f.Position=function(b,c,d){var e=!1;if(3==arguments.length){var g=void 0,h=void 0;"string"==a.utilities.TypeOfThing(b)&&(b=[arguments[0]]);a.component.IsComponentObject(c)&&(g=a.component.Fetch(c));a.component.IsComponentObject(d)&&(h=a.component.Fetch(d));if("object"==typeof b&&null!==g&&null!==h){var e=!0,f=a.component.FetchDimensionsAndPosition(g),k=a.component.FetchDimensionsAndPosition(h),h=f.height,f=f.width,m=k.top,n=k.left,q=f-k.width,r=m-h,k=m+k.height,m=n;0<q?m=
n-q:0>q&&(m=n+Math.abs(q));for(var t=0,v=b;t<v.length;t++){var u=v[t],p=void 0;switch(u){case "above":p=0<=r?r:k;break;case "below":p=k<=a.device.height-h?k:r;break;case "left":p=0<=n&&n+f<a.device.width-f?n:m;break;case "right":p=0<m?m:n;break;case "center":0<q?(p=q/2,p=n-p+f>a.device.width?m:0>n-p?n:n-p):p=0>q?n+Math.abs(q)/2:n}"above"==u||"below"==u?a.style.Set(g,"top",p.toString()+"px"):a.style.Set(g,"left",p.toString()+"px")}}}return e}})(a.render||(a.render={}))})(syiro||(syiro={}));
...
d.appendChild(a.component.Fetch(b)));"iOS"!==a.device.OperatingSystem&&(b=a.button.New({icon:"volume"}),d.appendChild(a.component.Fetch(b)));a.data.Write(c.id+"->HTMLElement",d);return c};f.ShowVolumeSlider=function(b,c){var d=a.component.Fetch(b),e=a.component.Fetch(c),g=a.component.FetchComponentObject(d.parentElement),f=a.mediaplayer.FetchInnerContentElement(g),l=d.querySelector('div[data-syiro-minor-component="progressbar"] > input');0==a.data.Read(g.id+"->IsChangingVolume")?(a.data.Write(g.id+
"->IsChangingInputValue",!0),a.data.Write(g.id+"->IsChangingVolume",!0),e.setAttribute("active","true"),a.data.Read(g.id+"->IsStreaming")&&d.removeAttribute("data-syiro-component-streamstyling"),l.setAttribute("max","10"),l.setAttribute("step","1"),a.mediaplayer.SetVolume(g,f.volume)):(e.removeAttribute("active"),a.data.Read(g.id+"->IsStreaming")&&d.setAttribute("data-syiro-component-streamstyling",""),d=a.mediaplayer.GetPlayerLengthInfo(g),l.setAttribute("max",d.max),l.setAttribute("step",d.step),
...
b.suggestions){d.suggestions="enabled";d.handlers={"list-item-handler":b.listItemHandler};var l=[];if("object"==typeof b.preseed){d.preseed=!0;for(var k in b.preseed)l.push(a.listitem.New({label:b.preseed[k]}))}else d.handlers.suggestions=b.handler,d.preseed=!1;k=a.list.New({items:l});var m=a.component.Fetch(k);e["aria-owns"]=k.id;m.setAttribute("data-syiro-component-owner",c);document.body.appendChild(m);if("undefined"!==typeof b.preseed)for(var n in l)a.events.Add(a.events.Strings.up,l[n],b.listItemHandler)}b=
...
(f[l.action]=l["function"]);var k=a.button.New({type:"basic",content:l.content}),k=a.component.Fetch(k);k.setAttribute("data-syiro-dialog-action",l.action);e.appendChild(k)}d.appendChild(e);0!==Object.keys(f).length&&a.data.Write(c+"->ActionHandlers",f)}else e=a.button.New({type:"basic",content:"x"}),d.appendChild(a.component.Fetch(e));a.data.Write(c+"->HTMLElement",d);return{id:c,type:"toast"}};f.Clear=function(b){a.toast.Toggle(b,"hide");a.component.Remove(b)};f.ClearAll=function(){var b=document.body.querySelectorAll('div[data-syiro-component="toast"]');
...
c.length/2,e=0;d&&(e=Math.round(c.length/2));for(var f=0;f<c.length;f++){var h=c[f],l="calc(100% / "+c.length+")";d&&f==e?l="calc(100% / "+c.length+" - 2px)":f==c.length-1&&(l="calc(100% / "+c.length+" - "+(c.length-1)+"px)");a.style.Set(h,"width",l)}}return b};f.Toggle=function(b){b=a.component.Fetch(b);var c=b.parentElement,d=a.component.FetchComponentObject(c),e=c.querySelector('div[data-syiro-component="button"][active]');null!==e&&e.removeAttribute("active");b.setAttribute("active","");a.component.Update(d.id,
