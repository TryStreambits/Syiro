...
"undefined"!==typeof a.title?"LinkPropertiesObject":1==Array.isArray(a)?"Array":a.toString().replace("[object ","").replace("]",""):"undefined"!==typeof a.nodeType&&(9!==a.nodeType?d="Element":9==a.nodeType&&(d="Document")));"string"==typeof c&&(d=c==d);return d}})(a.utilities||(a.utilities={}))})(syiro||(syiro={}));
(function(a){(function(f){f.GetObject=function(b){var c={},d=b;"ComponentObject"==a.utilities.TypeOfThing(b)&&(d=a.component.Fetch(b));b="";d.hasAttribute("style")&&(b=d.getAttribute("style"));if(a.utilities.TypeOfThing(b,"string")){var d=b.split(";"),e;for(e in d)b=d[e].replace(" ",""),""!==b&&(b=b.split(":"),c[b[0]]=b[1])}return c};f.Get=function(b,c){var d=a.style.GetObject(b)[c];a.utilities.TypeOfThing(d,"string")||(d="");return d};f.LoadColors=function(){var b=a.utilities.ElementCreator("div",
{"data-syiro-component":"internalColorContainer"});document.body.appendChild(b);var c=window.getComputedStyle(b);a.backgroundColor=c.backgroundColor;a.primaryColor=c.color;a.secondaryColor=c.borderColor;document.body.removeChild(b)};f.Set=function(b,c,d){var e=!0,g=a.utilities.TypeOfThing(b),h=b;"ComponentObject"==g?h=a.component.Fetch(b):"ComponentObject"!==g&&"Element"!==g&&(e=!1);e&&(b=function(b,c,d){var e=a.style.GetObject(b);e[c]=d;c="";for(var g in e)""!==e[g]&&(c=c+g+": "+e[g]+";");0!==c.length?
b.setAttribute("style",c):b.removeAttribute("style")}.bind(this,h,c,d),a.utilities.Run(b));return e}})(a.style||(a.style={}))})(syiro||(syiro={}));
...
navigator.userAgent.indexOf("iPhone")?c.BackgroundImage=b.art:g.poster=b.art:"audio"==b.type&&(e.setAttribute("data-syiro-audio-player","mini"),delete b.menu);g=a.utilities.ElementCreator(b.type,g);g.autoplay=!1;h=0;for(f=a.mediaplayer.GenerateSources(b.type,b.sources);h<f.length;h++)g.appendChild(f[h]);"boolean"==typeof b.UsingExternalLibrary&&b.UsingExternalLibrary&&(c.UsingExternalLibrary=!0);e.insertBefore(g,e.firstChild);c.HTMLElement=e;a.data.Write(d.id,c);return d};f.Configure=function(b){var c=
a.component.Fetch(b);a.mediaplayer.FetchInnerContentElement(b);var d=c.querySelector('div[data-syiro-component="media-control"]');if(0==a.data.Read(b.id+"->NoUX")){"video"==c.getAttribute("data-syiro-component-type")&&c.removeAttribute("data-syiro-show-video");var e=d.querySelector('div[data-syiro-render-icon="play"]');a.style.Set(e,"background-image","");e.removeAttribute("active");e=d.querySelector('div[data-syiro-render-icon="volume"]');null!==e&&e.removeAttribute("active");var g=a.mediaplayer.IsPlayable(b,
!0),e=c.querySelector('div[data-syiro-minor-component="player-error"]');null==e&&(e=a.utilities.ElementCreator("div",{"data-syiro-minor-component":"player-error",content:"This content is not capable of being played on this browser or device."}),c.insertBefore(e,c.firstChild));c=d.querySelector("time");1==g||"streamable"==g?("streamable"==g?(a.data.Write(b.id+"->IsStreaming",!0),d.setAttribute("data-syiro-component-streamstyling",""),null!==c&&(c.setAttribute("data-syiro-component-live",""),c.textContent=
"Live")):(a.data.Delete(b.id+"->IsStreaming"),d.removeAttribute("data-syiro-component-streamstyling"),null!==c&&(c.removeAttribute("data-syiro-component-live"),c.textContent="00:00",c=a.mediaplayer.GetPlayerLengthInfo(b),d=a.component.FetchComponentObject(d),a.mediacontrol.TimeLabelUpdater(d,1,c.max))),a.style.Set(e,"visibility","")):a.style.Set(e,"visibility","visible")}a.data.Delete(b.id+"->IsChangingInputValue");a.data.Delete(b.id+"->IsChangingVolume")};f.DurationChange=function(b){if(0==a.data.Read(b.id+
"->IsStreaming")){var c=a.component.Fetch(b).querySelector('div[data-syiro-component="media-control"]'),d=a.component.FetchComponentObject(c),c=c.querySelector('input[type="range"]');b=a.mediaplayer.GetPlayerLengthInfo(b);c.setAttribute("max",b.max);c.setAttribute("step",b.step);a.mediacontrol.TimeLabelUpdater(d,1,b.max)}};f.FetchInnerContentElement=function(b){b=a.component.Fetch(b);return b.querySelector(b.getAttribute("data-syiro-component-type"))};f.FetchSources=function(b){b=a.mediaplayer.FetchInnerContentElement(b).querySelectorAll("source");
var c=[],d;for(d in b){var e=b[d];a.utilities.TypeOfThing(e,"Element")&&c.push({src:e.getAttribute("src"),streamable:e.getAttribute("data-syiro-streamable-source"),type:e.getAttribute("type")})}return c};f.GenerateSources=function(b,c){for(var d=[],e=0;e<c.length;e++){var g=c[e],h=g.substr(0,g.indexOf(":")),f=g.substr(g.lastIndexOf(".")).replace(".",""),k={src:g,"data-syiro-streamable-source":"false"};";"!==g.substr(-1)&&("rtsp"==h||"rtmp"==h?(k["data-syiro-streamable-source"]="true",k.type=h+"/"+
f):"m3u8"==f?(k["data-syiro-streamable-source"]="true",k.type="application/x-mpegurl"):("mov"==f&&(f="quicktime"),k.type=b+"/"+f),d.push(a.utilities.ElementCreator("source",k)))}return d};f.GetPlayerLengthInfo=function(b){var c={};b=a.mediaplayer.FetchInnerContentElement(b).duration;0==isNaN(b)&&isFinite(b)?(c.max=b,c.step=60>b?1:60<b&&300>=b?5:300<b&&900>b?10:15):isNaN(b)?(c.max="Unknown",c.step=1):0==isFinite(b)&&(c.max="Streaming",c.step=1);return c};f.IsPlayable=function(b,c){a.component.Fetch(b);
var d=a.mediaplayer.FetchInnerContentElement(b),e=!1,g=!1;if(a.data.Read(b.id+"->UsingExternalLibrary"))g=e=!0;else for(var h=0,f=a.mediaplayer.FetchSources(b);h<f.length;h++){var k=f[h];if(""!==d.canPlayType(k.type)){e=!0;break}if(!g&&a.utilities.TypeOfThing(k.streamable,"string")&&"true"==k.streamable){g=!0;break}}return c&&g?"streamable":e?!0:!1};f.IsPlaying=function(b){a.component.Fetch(b);return!a.mediaplayer.FetchInnerContentElement(b).paused};f.IsStreamable=function(b){return"streamable"==
a.mediaplayer.IsPlayable(b,!0)};f.PlayOrPause=function(b,c){var d=a.component.Fetch(b),e=a.mediaplayer.FetchInnerContentElement(b),g=a.utilities.TypeOfThing(c);"video"==d.getAttribute("data-syiro-component-type")&&d.setAttribute("data-syiro-show-video","true");d="ComponentObject"==g?a.component.Fetch(c):"Element"!==g||"play"!==c.getAttribute("data-syiro-render-icon")?d.querySelector('div[data-syiro-render-icon="play"]'):c;a.mediaplayer.IsPlaying(b)?(e.pause(),d.removeAttribute("active")):(e.play(),
d.setAttribute("active","pause"))};f.Reset=function(b){a.component.Fetch(b);var c=a.mediaplayer.FetchInnerContentElement(b);a.mediaplayer.IsPlaying(b)&&c.pause();a.mediaplayer.SetTime(b,0);a.mediaplayer.Configure(b)};f.SetSources=function(b,c){a.component.Fetch(b);var d=a.mediaplayer.FetchInnerContentElement(b),e=d.nodeName.toLowerCase();"string"==typeof c&&(c=[c]);e=a.mediaplayer.GenerateSources(e,c);d.innerHTML="";for(var g=0;g<e.length;g++)d.appendChild(e[g]);d.setAttribute("src",c[0]);d.src=c[0];
a.mediaplayer.Reset(b)};f.SetTime=function(b,c){var d=a.component.Fetch(b),e=a.mediaplayer.FetchInnerContentElement(b),g=e.currentTime,h=g,f=!0;"number"==typeof c&&(h=c,f=!1,g!==h&&h<=e.duration&&(e.currentTime=h));d=d.querySelector('div[data-syiro-component="media-control"]');e=a.component.FetchComponentObject(d);d=d.querySelector("input");a.mediacontrol.TimeLabelUpdater(e,0,h);0==a.data.Read(b.id+"->IsStreaming")&&(e=!1,g=a.data.Read(b.id+"->IsChangingInputValue"),!f&&g?e=!0:f&&!g&&(e=!0),e&&(h=
Math.floor(h),d.value=h,a.style.Set(d,"background","linear-gradient(to right, "+a.primaryColor+" "+(h/Number(d.max)*d.clientWidth+2)+"px, transparent 0px)")))};f.SetVolume=function(b,c,d){var e=a.component.Fetch(b);b=a.mediaplayer.FetchInnerContentElement(b);var e=e.querySelector('input[type="range"]'),g=c;"string"==typeof d&&"input"==d?(g*=10,c/=10):10<g&&100>=g?(g=10*Math.round(c/10),c/=100):1<g&&10>=g?(g*=10,c/=10):1>=g&&(g*=100);a.style.Set(e,"background","linear-gradient(to right, "+a.primaryColor+
" "+g+"%, transparent 0px)");b.volume=c};f.ToggleFullscreen=function(b){b=a.component.Fetch(b);document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||document.msFullscreenElement?"undefined"!==typeof document.exitFullscreen?document.exitFullscreen():"undefined"!==typeof document.msExitFullscreen?document.msExitFullscreen():"undefined"!==typeof document.mozCancelFullScreen?document.mozCancelFullScreen():"undefined"!==typeof document.webkitExitFullscreen&&document.webkitExitFullscreen():
...
"true"),a.style.Set(b,"visibility","visible")):(c.removeAttribute("active"),a.style.Set(b,"visibility",""))}})(a.mediaplayer||(a.mediaplayer={}))})(syiro||(syiro={}));
...
b,a.list.Toggle))};f.MediaPlayer=function(b){if(0==a.data.Read(b.id+"->NoUX")){var c=a.component.Fetch(b),d=a.mediaplayer.FetchInnerContentElement(b),e=c.querySelector('div[data-syiro-component="media-control"]'),e=a.component.FetchComponentObject(e);a.events.Add("contextmenu",d,function(a,b){b.preventDefault()});a.events.Add("durationchange",d,a.mediaplayer.DurationChange.bind(this,b));a.events.Add("timeupdate",d,function(b){a.mediaplayer.SetTime(b,"tick")}.bind(this,b,"tick"));a.events.Add("ended",
